...
enum L10n {
    ...
    private static let zh: [String: String] = [
        ...
        "services_gemini": "仅 Gemini",
        "services_codex_claude": "Codex 和 Claude",
        "services_codex_gemini": "Codex 和 Gemini",
        "services_claude_gemini": "Claude 和 Gemini",
        "status_active": "已登录",
    ...
    private static let en: [String: String] = [
        ...
        "services_gemini": "Gemini only",
        "services_codex_claude": "Codex & Claude",
        "services_codex_gemini": "Codex & Gemini",
        "services_claude_gemini": "Claude & Gemini",
